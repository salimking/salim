...
class Notification(models.Model):
    ...
    from_user = models.ForeignKey('authentication.Profile', related_name='n_from',on_delete=models.CASCADE)
    to_user = models.ForeignKey('authentication.Profile', related_name='n_to',on_delete=models.CASCADE)
    date = models.DateTimeField(auto_now_add=True)
    order = models.ForeignKey(Order, null=True, blank=True,on_delete=models.CASCADE)
    medicine = models.ForeignKey('useradmin.Medicine', null=True, blank=True,on_delete=models.CASCADE)
    stock = models.ForeignKey('usershop.ShopStock', null=True, blank=True,on_delete=models.CASCADE)
